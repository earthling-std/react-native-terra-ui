...
/**
 * Access the active theme and switch scheme / accent.
 * Must be used under {@link UIKitProvider}.
 */
...
const noopSetAccent = (_name: string): void => {
  if (__DEV__) {
    console.warn(
      '[react-native-terra-ui] setAccent called outside <UIKitProvider>.'
    );
  }
};
